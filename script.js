...
function showWhatsAppSelector() {
                ...
                <div class="owner-options">
                    ...
                    <div class="owner-option" data-owner="3">
                        ...
                        <div class="owner-info">
                            ...
                            <div class="owner-number">+62 813-5983-2627</div> <!-- PERBAIKAN DI SINI -->
                        </div>
                        <span class="owner-status status-available">🟢 Online</span> <!-- PERBAIKAN DI SINI -->
                    </div>
                </div>
    ...
    ownerOptions.forEach(option => {
        option.addEventListener('click', function() {
            ...
            // SEMUA OWNER AKTIF (hapus warning untuk owner 3)
    ...
    confirmBtn.addEventListener('click', function() {
        if (!selectedOwner) {
            alert('Silakan pilih Owner yang ingin dihubungi.');
            return;
        }
        ...
        } else if (selectedOwner === '3') {
            whatsappNumber = '6281359832627';
        }
    ...
    function addWhatsAppQuickButtons() {
        ...
        whatsappQuick.innerHTML = `
            ...
            <a href="https://wa.me/6285656863541?text=Halo%20V2S%20FREE%20FIRE%20CHEAT%20AND%20TOOLS,%20saya%20mau%20tanya%20tentang%20panel%20FreeFire" class="whatsapp-btn owner2" target="_blank">
             ...
             <a href="https://wa.me/6281359832627?text=Halo%20V2S%20FREE%20FIRE%20CHEAT%20AND%20TOOLS,%20saya%20mau%20tanya%20tentang%20panel%20FreeFire" class="whatsapp-btn owner3" target="_blank">
                <i class="fab fa-whatsapp"></i>
                <span class="whatsapp-tooltip">Hubungi Owner 3</span>
            </a>
        `;
